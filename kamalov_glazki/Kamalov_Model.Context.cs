...
namespace kamalov_glazki
{
    ...
    public partial class Kamalov_Entities : DbContext
    {
        private static Kamalov_Entities _context;
        public static Kamalov_Entities GetContext()
        {
            if (_context == null)
            {
                _context = new Kamalov_Entities();
            }
            return _context;
        }
        public Kamalov_Entities()
            : base("name=Kamalov_Entities")
        {
        }
